...
const Slider = (props) => {
  ...
  return (
    <div className="w-full h-full gap-5 flex-row justify-start items-center">
      ...
      <RangeSlider defaultValue={[initTotal, initTotal + left / 2]} thumbsDisabled={[true, false]} max={100} ref={ref} id="container" onThumbDragEnd={updated} step={1} className="w-2/3" />
